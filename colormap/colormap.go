...
func CSMthemePicker(ThemeName string) (cs CSM) {
	...
	case "arseny":
		...
		cs[CsDbOk] = ColorSheme{CreateCS(ClrFgBlue, ClrBold), CreateCS(ClrFgMagenta, ClrBold), CreateCS(ClrFgGreen, ClrBold), NewLine, CreateCS(ClrBgCyan, ClrBold)}
		cs[CsDbFail] = ColorSheme{CreateCS(ClrFgBlue, ClrBold), CreateCS(ClrFgMagenta, ClrBold), CreateCS(ClrFgRed, ClrBold), RepeatColor, NewLine, CreateCS(ClrBgCyan, ClrBold)}
		cs[CsRedis] = ColorSheme{CreateCS(ClrFgMagenta, ClrBold), CreateCS(ClrFgBlue, ClrBold), NewLine, CreateCS(ClrBgMagenta, ClrBold)}
		cs[CsRedisOk] = ColorSheme{CreateCS(ClrFgMagenta, ClrBold), CreateCS(ClrFgGreen, ClrBold), NewLine, CreateCS(ClrBgMagenta, ClrBold)}
		cs[CsRedisFail] = ColorSheme{CreateCS(ClrFgMagenta, ClrBold), CreateCS(ClrFgRed, ClrBold), NewLine, CreateCS(ClrBgMagenta, ClrBold)}
